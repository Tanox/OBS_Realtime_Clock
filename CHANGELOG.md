...
### 新功能
- **GEO 多时区支持**：新增 30+ 全球主要城市时区预设
  - 亚洲城市：北京、东京、首尔、新加坡、香港、台北、曼谷、胡志明市、雅加达、马尼拉、吉隆坡、孟买、班加罗尔、卡拉奇、迪拜
  - 欧洲城市：伦敦、巴黎、柏林、罗马、马德里、莫斯科
  - 美洲城市：纽约、洛杉矶、芝加哥、多伦多、温哥华、圣保罗
  - 大洋洲城市：悉尼、奥克兰
  - 非洲城市：开罗、约翰内斯堡
- **自定义时区偏移**：支持 -12 到 +14 小时的自定义时区偏移，精度 0.5 小时
- **时区标签显示**：可选择显示时区缩写标签（如 CST、EST、JST 等），支持前置、后置、换行三种位置
- **SEO 元数据优化**：丰富脚本头部标签和描述信息，包含功能关键词便于搜索发现

### 改进
- 重构时区计算逻辑，统一使用 UTC 基准时间加减偏移量的方式
- 优化脚本描述界面，增加完整功能特性列表的双语展示
- 所有时区预设均包含标准时区缩写标签

### 文档更新
- 同步更新所有文档的版本号至 v1.2.0
